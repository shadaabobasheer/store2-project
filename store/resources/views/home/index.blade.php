    ...
    <div class="container marketing">
        ...
        <form method="GET" action="{{ url('/') }}" class="mb-3">
            ...
            <select name="category" id="category" class="form-select w-25 d-inline-block">
                <option value="all" {{ request('category') == 'all' ? 'selected' : '' }}>جميع الفئات</option>
            ...
            <button type="submit" class="btn btn-primary ms-2">اذهب</button>
        </form>


        <!-- ثلاثة أعمدة من النصوص أسفل السلايدر -->
        <div class="row">
