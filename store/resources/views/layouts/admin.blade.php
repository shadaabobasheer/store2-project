...
<body>
    ...
    {{-- <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        ...
        <div class="container">
            <input class="form-control w-80 bg-dark text-white border-dark" type="text" placeholder="بحث" aria-label="بحث">

        </div>
        <br>
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-gray" href="#"
            style="margin-left: auto; color: gray;">تسجيل الخروج</a>
