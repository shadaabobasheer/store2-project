...
<head>
    ...
    <style>
        input::placeholder {
    color: #555 !important;  /* لون أغمق من اللون الافتراضي */
}

/* تخصيص لون خلفية حقل البحث */
.form-control {
    background-color: white !important; /* تعيين خلفية بيضاء */
    color: #000; /* تعيين لون النص إلى الأسود */
}
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <form class="d-flex" role="search">
                        <input class="form-control me-2 bg-white" type="search" placeholder="بحث" aria-label="بحث">
